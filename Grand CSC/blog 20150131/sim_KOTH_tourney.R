...
# based on random number of top 100 WESPA player (always including the number 1)
##########
...
write.csv(matchup.log, "matchup_log_100.csv", row.names=FALSE)
write.csv(tourney.log, "standing_log_100.csv", row.names=FALSE)
